...
class NavWalker extends \Walker_Nav_Menu {
  ...
  function display_element($element, &$children_elements, $max_depth, $depth = 0, $args, &$output) {
    ...
    if ($element->is_dropdown) {
      $navbar_position = function_exists('get_field') ? get_field('navbar_position', 'options') : 'navbar-static-top';
      $element_class = ($navbar_position === 'navbar-fixed-bottom') ? 'dropup' : 'dropdown';
      $element->classes[] = $element_class;
